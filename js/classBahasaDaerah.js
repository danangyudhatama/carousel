...
arrayBahasaDaerah.push(new BahasaDaerah("Jeges do koding i, tai ulang marlobi-lobi","Mandailing"));
...
arrayBahasaDaerah.push(new BahasaDaerah("koding nyan get tapi bek teuga that","Aceh"));
arrayBahasaDaerah.push(new BahasaDaerah("Koding tu sadap... mar jang labeh","Ambon"));
arrayBahasaDaerah.push(new BahasaDaerah("Koding itu cindo, tapi jangan keliwat..","Palembang"));
arrayBahasaDaerah.push(new BahasaDaerah("Koding ino bagus laguk dendek nyawat lalok","Lombok Timur"));
arrayBahasaDaerah.push(new BahasaDaerah("koding no solah, laguk dendek loek-loek","Bahasa Sasak"));
arrayBahasaDaerah.push(new BahasaDaerah("Koding ngitu bagus haja, tapi kada usah balabihan jua","Bahasa Banjar"));
arrayBahasaDaerah.push(new BahasaDaerah("koding tu bagos, tapi osah belebeh","Pontianak"));
arrayBahasaDaerah.push(new BahasaDaerah("koding tu bawak santai bae, nyap duduk ketik lah apo yg nak di ketik..","Jambi"));
arrayBahasaDaerah.push(new BahasaDaerah("Koding tu baek tapi hik kawa kemahotan","Bahasa Kutai"));
arrayBahasaDaerah.push(new BahasaDaerah("Koding re caru, Pala ain ipi","Bahasa Bima"));
arrayBahasaDaerah.push(new BahasaDaerah("Ngoding geno bais, tapi sama kenjulu","Bahasa Tidung,Tarakan"));
arrayBahasaDaerah.push(new BahasaDaerah("koding itu gaga mar jang talalu ba lebe","Manado"));
